  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "[REGISTRO] Error enviando email de verificación:",
          e.message,
        );
      }
            ...
            onPress: async () => {
              try {
                ...
                if (userCredential.user.emailVerified) {
                  ...
                  Alert.alert(
                    "Aún no verificado",
                    "No hemos detectado la verificación. Revisa tu correo y luego pulsa 'Ya verifiqué'.",
                  );
                }
              } catch (e: any) {
                Alert.alert(
                  "Error",
                  e.message || "No se pudo comprobar la verificación",
                );
              }
            },
          },
      ...
      <TouchableOpacity
        ...
        onPress={async () => {
          if (Platform.OS !== "web") {
            Alert.alert(
              "Registro con Google",
              "El registro con Google solo está disponible en la versión web.",
            );
            return;
          }
          try {
